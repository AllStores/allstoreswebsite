								...
								<!-- Nav -->
									<nav id="nav">
										<ul>
											...
											<li class="current_page_item"><a href="rightsidebar">Right Sidebar</a></li>
									...
									<div id="content">
										...
										<!-- Content -->
											...
											<article>
												...
												<span class="image featured"><img src="static/images/pic08.jpg" alt="" /></span>
								...
								<div class="8u">
									...
									<!-- Article list -->
										<section class="box article-list">
											...
											<!-- Excerpt -->
												<article class="box excerpt">
													<a href="#" class="image left"><img src="static/images/pic05.jpg" alt="" /></a>
													<div>
														<header>
